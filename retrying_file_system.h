...
class S3RetryingFileSystem : public FileSystem {
 public:
  S3RetryingFileSystem(std::unique_ptr<FileSystem> base_file_system,
 ...
 private:
  ...
  TF_DISALLOW_COPY_AND_ASSIGN(S3RetryingFileSystem);
};
}
}  // namespace tensorflow
